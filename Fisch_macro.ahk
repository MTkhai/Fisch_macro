...
if WinActive("Roblox")
	...
	{
	msgbox, where is your roblox? have you open it
	exitapp
	}
...
tooltip, Made By MTkhai, %TooltipX%, %Tooltip1%, 1
tooltip, Runtime: 0h 0m 0s, %TooltipX%, %Tooltip2%, 2

tooltip, Press "F" to Start, %TooltipX%, %Tooltip4%, 4
tooltip, Press "R" to Reload, %TooltipX%, %Tooltip5%, 5
tooltip, Press "X" to Exit, %TooltipX%, %Tooltip6%, 6
...
tooltip, Press "R" to Reload, %TooltipX%, %Tooltip4%, 4
